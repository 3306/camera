...
namespace ServerDLL
{
    public class AviCapture
    {
        ...
        public const int WM_CAP_SET_CALLBACK_ERROR = WM_START + 2;//设置回调错误
        public const int WM_CAP_SET_CALLBACK_STATUS = WM_START + 3;//设置回调状态
        public const int WM_CAP_SET_CALLBACK_YIELD = WM_START + 4;//设置回调出产
        public const int WM_CAP_SET_CALLBACK_FRAME = WM_START + 5;//设置回调结构
        public const int WM_CAP_SET_CALLBACK_VIDEOSTREAM = WM_START + 6;//设置回调视频流
        public const int WM_CAP_SET_CALLBACK_WAVESTREAM = WM_START + 7;//设置回调视频波流
        ...
        public const int WM_CAP_SET_CALLBACK_CAPCONTROL = WM_START + 85;// 设置回调的错误
        #endregion 消息常量
